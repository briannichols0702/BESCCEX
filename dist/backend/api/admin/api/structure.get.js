...
exports.apiKeyStructure = exports.metadata = void 0;
...
exports.apiKeyStructure = apiKeyStructure;
exports.default = async () => {
    const { id, name, userId, key, type, permissionIds, ipWhitelist, ipRestriction, } = await (0, exports.apiKeyStructure)();
    const permissions = {
        type: "tags",
        label: "Permissions",
        name: "permissions",
