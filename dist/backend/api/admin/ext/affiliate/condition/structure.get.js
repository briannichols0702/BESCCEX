...
exports.mlmReferralConditionStructure = exports.metadata = void 0;
...
const mlmReferralConditionStructure = async () => {
    const title = {
        type: "input",
        label: "Title",
        name: "title",
...
exports.mlmReferralConditionStructure = mlmReferralConditionStructure;
exports.default = async () => {
    const { title, description, reward, rewardType, rewardWalletType, rewardCurrency, image, } = await (0, exports.mlmReferralConditionStructure)();
    return {
        get: [
            title,
            description,
