            ...
            "application/json": {
                schema: {
                    ...
                    properties: {
                        status: {
                            type: "boolean",
                            description: "New status to apply to the E-commerce discount (true for active, false for inactive)",
                        },
                    },
                    required: ["status"],
                },
...
exports.default = async (data) => {
    ...
    const { id } = params;
    const { status } = body;
    return (0, query_1.updateStatus)("ecommerceDiscount", id, status);
};
