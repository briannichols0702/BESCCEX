...
exports.metadata = {
    summary: "Retrieves detailed information of a specific ecommerce product by ID",
        ...
        200: {
            ...
            content: {
                "application/json": {
                    schema: {
                        type: "object",
                        properties: utils_1.baseEcommerceProductSchema, // Define this schema in your utils if it's not already defined
                    },
                },
            },
        },
...
exports.default = async (data) => {
    const { params } = data;
    return await (0, query_1.getRecord)("ecommerceProduct", params.id, [
        {
