...
exports.ecommerceShippingtructure = exports.metadata = void 0;
...
const ecommerceShippingtructure = () => {
    const loadId = {
        type: "input",
        label: "Load ID",
        name: "loadId",
...
exports.ecommerceShippingtructure = ecommerceShippingtructure;
exports.default = async () => {
    const { loadId, loadStatus, shipper, transporter, goodsType, weight, volume, description, vehicle, cost, tax, } = (0, exports.ecommerceShippingtructure)();
    return {
        get: [
            {
                type: "input",
