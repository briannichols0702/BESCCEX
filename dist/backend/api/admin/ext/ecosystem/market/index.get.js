...
exports.metadata = {
    summary: "Lists all ecosystem market entries with pagination and optional filtering",
    operationId: "listEcosystemMarkets",
    tags: ["Admin", "Ecosystem", "Markets"],
    parameters: constants_1.crudParameters,
    responses: {
        200: {
            description: "List of ecosystem markets with optional details on trending status and metadata",
            content: {
                "application/json": {
                    schema: {
                        type: "object",
