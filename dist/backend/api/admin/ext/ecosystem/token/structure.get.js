...
exports.ecosystemTokenStructure = exports.metadata = void 0;
...
const ecosystemTokenStructure = async () => {
...
exports.ecosystemTokenStructure = ecosystemTokenStructure;
exports.default = async () => {
    const { contract, name, currency, chain, network, type, decimals, status, precision, limits, fee, icon, contractType, initialHolder, initialSupply, marketCap, } = await (0, exports.ecosystemTokenStructure)();
    return {
        get: [
            icon,
            [name, currency],
