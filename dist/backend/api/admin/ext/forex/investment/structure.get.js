...
exports.forexInvestmentStructure = exports.metadata = void 0;
...
const forexInvestmentStructure = async () => {
    const plans = await db_1.models.forexPlan.findAll({ where: { status: true } });
...
exports.forexInvestmentStructure = forexInvestmentStructure;
exports.default = async () => {
    const { userId, planId, durationId, amount, profit, result, status, endDate, } = await (0, exports.forexInvestmentStructure)();
    return {
        get: [
            {
                fields: [
