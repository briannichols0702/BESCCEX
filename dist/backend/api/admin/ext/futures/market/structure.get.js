...
exports.futuresMarketStructure = exports.metadata = void 0;
...
const futuresMarketStructure = async () => {
                ...
                fields: [
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            label: "Leverage",
                            name: "leverage",
                            placeholder: "Enter the leverage, multiple values separated by comma",
                        },
                    ],
                ],
            },
...
exports.futuresMarketStructure = futuresMarketStructure;
exports.default = async () => {
    const { currency, pair, isTrending, isHot, metadata, status } = await (0, exports.futuresMarketStructure)();
    return {
