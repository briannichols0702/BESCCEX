        ...
        200: {
            ...
            content: {
                "application/json": {
                    schema: {
                        type: "object",
                        properties: utils_1.baseIcoAllocationSchema, // Define this schema in your utils if it's not already defined
                    },
                },
            },
        },
        401: query_1.unauthorizedResponse,
        404: (0, query_1.notFoundMetadataResponse)("ICO Allocation"),
...
exports.default = async (data) => {
    const { params } = data;
    return await (0, query_1.getRecord)("icoAllocation", params.id, [
        {
