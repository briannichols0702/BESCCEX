...
exports.icoPhaseStructure = exports.metadata = void 0;
...
exports.icoPhaseStructure = icoPhaseStructure;
exports.default = async () => {
    const { name, startDate, endDate, price, status, tokenId, minPurchase, maxPurchase, } = await (0, exports.icoPhaseStructure)();
    return {
        get: [
            name,
            {
