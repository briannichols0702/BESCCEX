...
exports.gatewayStructure = exports.metadata = void 0;
...
exports.gatewayStructure = gatewayStructure;
exports.default = async () => {
    const { name, title, description, image, currencies, fixedFee, percentageFee, minAmount, maxAmount, type, status, } = (0, exports.gatewayStructure)();
    return {
        get: [
            {
                fields: [
