...
exports.exchangeMarketStructure = exports.metadata = void 0;
...
const exchangeMarketStructure = async () => {
    const metadata = {
        type: "object",
        name: "metadata",
        label: "Metadata",
...
exports.exchangeMarketStructure = exchangeMarketStructure;
exports.default = async () => {
    const { metadata, isTrending, isHot } = await (0, exports.exchangeMarketStructure)();
    return {
        get: [],
        set: [],
