...
exports.default = async () => {
    const { name, title, description, minProfit, maxProfit, minAmount, maxAmount, invested, profitPercentage, status, defaultProfit, defaultResult, trending, durationIds, currency, walletType, } = await (0, exports.investmentPlanStructure)();
    return {
        get: [
            {
                fields: [
