...
exports.tableConfigs = [
    {
        ...
        transform: (record, idMapping, tableName) => {
            ...
            const transformedRecord = {
                ...
                emailVerified: record.email_verified !== undefined
        ...
        transform: (record, idMapping, tableName) => {
            ...
            if (typeof record.addresses === "string") {
                try {
                    ...
                    const unescapedAddresses = record.addresses.replace(/\\([\s\S])/g, "$1");
    ...
    },
    {
        ...
        hasUuid: true,
        transform: (record, idMapping, tableName) => {
            const masterWalletId = idMapping[`ecosystem_master_wallet_${record.master_wallet_id}`];
    ...
    },
    {
        ...
        hasUuid: false,
        transform: (record, idMapping, tableName) => {
            const walletId = idMapping[`ecosystem_custodial_wallet_${record.wallet_id}`];
            if (!walletId) {
                return null; // Skip if walletId is not found in idMapping
            }
            const newId = (0, uuid_1.v4)();
    ...
    },
    {
        ...
        transform: (record, idMapping, tableName) => {
            ...
            if (typeof record.metadata === "string") {
                try {
                    // Unescape the JSON string
                    const unescapedMetadata = record.metadata.replace(/\\([\s\S])/g, "$1");
            ...
            return {
                id: newId,
                currency: (_a = record.symbol.split("/")) === null || _a === void 0 ? void 0 : _a[0],
                pair: record.pair,
    ...
    },
    {
        ...
        hasUuid: false,
        transform: (record, idMapping, tableName) => {
            const conditionId = idMapping[`mlmReferralCondition_${record.condition_id}`];
            const referrerId = idMapping[`user_${record.referrerUuid}`];
