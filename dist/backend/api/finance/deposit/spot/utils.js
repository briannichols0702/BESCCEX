...
exports.parseMetadataAndMapChainToXt = exports.mapToXtNetwork = exports.normalizeUserChain = exports.parseTransactionMetadata = void 0;
/**
 ...
 */
function parseTransactionMetadata(metadataString) {
    ...
    try {
        ...
        console.error("Error parsing transaction metadata on first attempt:", metadataStr, error === null || error === void 0 ? void 0 : error.message);
    ...
    if (typeof parsed === "string") {
        try {
            ...
            console.error("Error parsing transaction metadata on second attempt:", parsed, error === null || error === void 0 ? void 0 : error.message);
...
function normalizeUserChain(chain) {
...
exports.normalizeUserChain = normalizeUserChain;
 ...
 */
function parseMetadataAndMapChainToXt(metadataString) {
