...
exports.serveStaticFile = exports.slugify = exports.statusOptions = exports.transactionTypeOptions = exports.delay = exports.cronLastRunTimes = exports.validAddonFolders = exports.convertAndSortCounts = exports.getCommonExpiration = exports.getStatusMessage = exports.setCORSHeaders = exports.setupProcessEventHandlers = exports.setupDefaultRoutes = exports.voidFunction = exports.handleArrayBuffer = exports.handleError = exports.errHandlerFn = exports.notFoundFn = exports.apiResponse = exports.notFoundResponse = exports.allowedOrigins = exports.appSupport = exports.appName = void 0;
...
exports.appSupport = process.env.NEXT_PUBLIC_APP_EMAIL || "support@mash3div.com";
...
function setupProcessEventHandlers() {
    process.on("uncaughtException", (error) => {
        ...
        (0, logger_1.logError)("uncaughtException", error, __filename);
    ...
    process.on("unhandledRejection", (reason, promise) => {
        ...
        (0, logger_1.logError)("unhandledRejection", new Error(reasonMessage), __filename);
    });
...
const setCORSHeaders = (res, origin) => {
    ...
    res.writeHeader("Access-Control-Allow-Headers", "*, client-platform, Content-Type, Authorization, X-Requested-With, accessToken, refreshToken, sessionId, csrfToken, x-api-key");
...
function compressResponse(res, req, responseData) {
    ...
    if (acceptEncoding.includes("gzip")) {
        response = zlib_1.default.gzipSync(response);
        contentEncoding = "gzip";
    }
    else if (acceptEncoding.includes("br") && zlib_1.default.brotliCompressSync) {
        response = zlib_1.default.brotliCompressSync(response);
        contentEncoding = "br";
    }
    else if (acceptEncoding.includes("deflate")) {
        response = zlib_1.default.deflateSync(response);
...
function serveStaticFile(res, req, filePath, markResponseSent) {
    ...
    try {
        ...
        if (filePath.startsWith("/uploads/")) {
            fullPath = path_1.default.join(process.cwd(), "public", sanitizedFilePath);
        }
        else if (filePath.startsWith("/themes/")) {
            fullPath = path_1.default.join(process.cwd(), sanitizedFilePath);
        }
