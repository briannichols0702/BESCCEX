...
const Dialog = ({ open, setOpen, node, actions }) => {
    ...
    const [path, setPath] = (0, react_1.useState)((_a = node.data.props[key]) === null || _a === void 0 ? void 0 : _a.path);
    return (<Modal_1.default open={open} size="md">
      <Card_1.default shape="smooth">
        ...
        <div className="p-4 md:px-6">
          <Textarea_1.default rows={4} shape="rounded-sm" label="SVG Path" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 mb-4" placeholder="Eg. d = 'M150 0 L75 200 L225 200 Z'" defaultValue={path} onChange={(e) => setPath(e.target.value)}/>
        </div>
