...
exports.cardVariants = (0, class_variance_authority_1.cva)("relative w-full transition-all duration-300", {
    variants: {
        color: {
            default: "bg-white dark:bg-muted-800 border border-muted-200 dark:border-muted-700",
            contrast: "bg-white dark:bg-muted-900 border border-muted-200 dark:border-muted-800",
            muted: "bg-muted-100 dark:bg-muted-800 border border-muted-200 dark:border-muted-700",
            mutedContrast: "bg-muted-100 dark:bg-muted-900 border border-muted-200 dark:border-muted-800",
