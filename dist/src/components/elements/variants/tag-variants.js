...
exports.tagVariants = void 0;
const class_variance_authority_1 = require("class-variance-authority");
exports.tagVariants = (0, class_variance_authority_1.cva)("relative inline-flex h-7 items-center justify-center font-sans whitespace-nowrap px-3 text-center text-xs gap-1 leading-10 transition-all duration-300", {
    variants: {
        color: {
            default: "",
            contrast: "",
    ...
    compoundVariants: [
        ...
        },
        {
            variant: "solid",
            color: "contrast",
            className: "border border-muted-200 dark:border-muted-800 bg-white dark:bg-muted-900 text-muted-500 dark:text-muted-100",
        },
        {
            variant: "solid",
            color: "muted",
