...
const SidebarCollapseProvider = ({ fullwidth = false, horizontal = false, }) => {
    return (<>
      <MenuContext_1.MenuContextProvider>
        <Menu_1.Menu collapse/>
      </MenuContext_1.MenuContextProvider>

      <AppNavbar_1.AppNavbar fullwidth={fullwidth ? fullwidth : false} horizontal={horizontal ? horizontal : false} collapse/>
...
exports.default = SidebarCollapseProvider;
