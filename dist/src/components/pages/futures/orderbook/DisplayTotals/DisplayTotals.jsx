...
exports.DisplayTotals = void 0;
const react_1 = require("react");
const next_i18next_1 = require("next-i18next");
const calculateTotals = (orders, startIndex, type) => {
    if (startIndex === null) {
...
const DisplayTotalsBase = ({ currency, pair, orderBook, hoveredIndex, hoveredType, cardPosition, isHovered, }) => {
    const { t } = (0, next_i18next_1.useTranslation)();
    if (hoveredType) {
        const totals = calculateTotals(hoveredType === "ask" ? orderBook.asks : orderBook.bids, hoveredType === "ask" ? hoveredIndex.ask : hoveredIndex.bid, hoveredType);
        return (<div className={`hover-card ${isHovered ? "visible" : ""} fixed p-2 border-l-2 z-20 border-primary-500 dark:border-primary-400 bg-muted-100 dark:bg-muted-900 text-muted-800 dark:text-muted-200 rounded-[.65rem] before:right-full after:right-full before:pointer-events-none before:absolute before:top-[20px] before:-mt-[9px] before:h-0 before:w-0 before:border-[9px] before:border-transparent after:pointer-events-none after:absolute after:top-[18px] after:-mt-2 after:h-0 after:w-0 after:border-[8px] after:border-transparent before:border-r-primary-500 after:border-r-primary-500  dark:before:border-r-primary-400 dark:after:border-r-primary-400 max-w-[80%] min-w-[15%]`} style={{
                top: (cardPosition === null || cardPosition === void 0 ? void 0 : cardPosition.top) - (hoveredType === "ask" ? 20 : 0),
                left: cardPosition === null || cardPosition === void 0 ? void 0 : cardPosition.left,
            }}>
        <div>
...
exports.DisplayTotals = (0, react_1.memo)(DisplayTotalsBase);
