...
const CreatorBanner = () => {
    ...
    return (<div className="w-full px-16 py-12 relative z-0 mb-32">
      {/* Right Glow Gradient */}
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-10 p-4 bg-purple-200 dark:bg-black rounded-xl z-9">
        ...
        <div className="w-full lg:w-1/2 bg-purple-300 dark:bg-transparent rounded-2xl overflow-hidden">
          <div className="relative w-full h-[300px] md:h-[400px] overflow-hidden rounded-2xl">
            <image_1.default src={bannerImage} alt="Create Unique Collection" fill style={{ objectFit: "cover" }} className="rounded-2xl"/>
          </div>
        </div>
        ...
        <div className="w-full lg:w-1/2 text-center lg:text-left space-y-6">
          ...
          <link_1.default href="/create" passHref className="inline-flex items-center px-6 py-3 bg-lime-500 hover:bg-lime-600 text-lg font-semibold text-white rounded-md transition ease-in-out duration-300 dark:text-black">
            Create Now
          </link_1.default>
        </div>
      </div>
