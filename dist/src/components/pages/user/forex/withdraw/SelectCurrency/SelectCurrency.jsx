...
const SelectCurrencyBase = ({}) => {
    ...
    const { selectedWalletType, setSelectedWalletType, currencies, selectedCurrency, setSelectedCurrency, setSelectedWithdrawMethod, setStep, fetchWithdrawMethods, } = (0, withdraw_1.useWithdrawStore)();
    return (<div>
