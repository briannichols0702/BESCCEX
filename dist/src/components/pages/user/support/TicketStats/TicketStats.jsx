...
exports.TicketStats = void 0;
const react_1 = require("react");
const Card_1 = __importDefault(require("@/components/elements/base/card/Card"));
const Button_1 = __importDefault(require("@/components/elements/base/button/Button"));
const next_i18next_1 = require("next-i18next");
const TicketStatsBase = ({}) => {
    const { t } = (0, next_i18next_1.useTranslation)();
    const [activeTab, setActiveTab] = (0, react_1.useState)("overview");
    return (<div className="mb-6">
      <Card_1.default color="contrast" className="relative overflow-hidden">
        <div className="border-b border-muted-200 bg-muted-100 px-6 dark:border-muted-800 dark:bg-muted-900/40">
          <div className="-mb-px flex flex-col md:flex-row items-center justify-between">
            <div className="flex gap-6">
              <button type="button" className={`appearance-none border-b-2 py-4 text-sm transition-colors duration-300
              ${activeTab === "overview"
            ...
            <div className="flex items-center gap-2 py-6 md:py-0">
              <Button_1.default type="button" size="sm" shape="full" className="w-12">
                {t("1m")}
              </Button_1.default>
              <Button_1.default type="button" size="sm" shape="full" className="w-12">
                {t("1d")}
              ...
              <Button_1.default type="button" size="sm" shape="full" color="primary" className="w-12">
                {t("1y")}
              </Button_1.default>
            </div>
          </div>
        ...
        <div>
          {activeTab === "overview" ? (<div className="grid grid-cols-1 divide-y md:divide-y-0 md:divide-x divide-muted-200 py-6 dark:divide-muted-800 md:grid-cols-2 lg:grid-cols-4 ltablet:grid-cols-4">
          ...
          {activeTab === "severity" ? (<div className="grid grid-cols-1 divide-y md:divide-y-0 md:divide-x divide-muted-200 py-6 dark:divide-muted-800 md:grid-cols-2 lg:grid-cols-4 ltablet:grid-cols-4">
              <div className="px-8 py-8 ltablet:py-2 lg:py-2 text-center flex flex-col items-center justify-center h-full">
                <div className="relative">
                  <div className="mb-2">
                    <p className="relative text-4xl font-normal text-muted-800 dark:text-muted-100">
          ...
          {activeTab === "statistics" ? (<div className="grid grid-cols-1 divide-y md:divide-y-0 md:divide-x divide-muted-200 py-6 dark:divide-muted-800 md:grid-cols-2 lg:grid-cols-4 ltablet:grid-cols-4">
              <div className="px-8 py-8 ltablet:py-2 lg:py-2 text-center flex flex-col items-center justify-center h-full">
                <div className="relative">
                  <div className="mb-2">
                    <p className="relative text-4xl font-normal text-muted-800 dark:text-muted-100">
...
exports.TicketStats = (0, react_1.memo)(TicketStatsBase);
