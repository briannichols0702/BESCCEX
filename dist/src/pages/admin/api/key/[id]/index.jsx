...
const ApiKeyEdit = () => {
    ...
    const fetchApiKey = async () => {
        ...
        if (!error && data) {
            ...
            sonner_1.toast.error(t("Failed to fetch API key data"));
        }
        setLoading(false);
    };
    ...
    if (loading)
        return null;
    return (<Default_1.default title={t("Edit API Key")} color="muted">
        ...
        <div className="mt-6">
          ...
          <div className="grid grid-cols-2 gap-3 mt-4">
            {permissionOptions.map((perm) => (<div key={perm.value} className="flex items-center gap-2">
                <Checkbox_1.default id={perm.value} checked={permissions.includes(perm.value)} onChange={() => handlePermissionToggle(perm.value)}/>
                <div>
