...
const EcommerceOrdersAnalytics = () => {
    ...
    return (<Default_1.default color="muted" title={t("Ecommerce Orders Analytics")}>
      <AnalyticsChart_1.AnalyticsChart model="ecommerceOrder" modelName={t("Ecommerce Orders")} cardName={t("Orders")} availableFilters={availableFilters} color="primary"/>
    </Default_1.default>);
};
