...
const EcommerceOrders = () => {
    ...
    return (<Default_1.default title={t("Ecommerce Orders")} color="muted">
      <datatable_1.DataTable title={t("Ecommerce Orders")} endpoint={api} columnConfig={columnConfig} canCreate={false} canEdit={false} viewPath="/admin/ext/ecommerce/order/[id]" hasAnalytics/>
    </Default_1.default>);
};
