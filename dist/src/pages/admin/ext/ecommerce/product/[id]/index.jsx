...
const EcommerceProductEdit = () => {
    ...
    const fetchProductData = async () => {
        ...
        if (!error && data) {
            ...
            setCategory((formData === null || formData === void 0 ? void 0 : formData.categories.find((cat) => cat.value === data.categoryId)) ||
                null);
            setInventoryQuantity(data.inventoryQuantity.toString());
            setFilePath(data.image);
            setWalletType((formData === null || formData === void 0 ? void 0 : formData.walletTypes.find((wallet) => wallet.value === data.walletType)) || null);
            setCurrency(((_a = formData === null || formData === void 0 ? void 0 : formData.currencyConditions[data.walletType]) === null || _a === void 0 ? void 0 : _a.find((cur) => cur.value === data.currency)) || null);
            setStatus([
    ...
    if (!formData)
        return null;
    return (<Default_1.default title={t("Edit E-commerce Product")} color="muted">
...
exports.default = EcommerceProductEdit;
