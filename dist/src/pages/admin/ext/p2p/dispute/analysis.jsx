...
const P2PsAnalytics = () => {
    ...
    return (<Default_1.default color="muted" title={t("P2P Disputes Analytics")}>
      <AnalyticsChart_1.AnalyticsChart model="p2pDispute" modelName={t("P2P Disputes")} cardName={t("Disputes")} availableFilters={availableFilters} color="primary"/>
    </Default_1.default>);
};
