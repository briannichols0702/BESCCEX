...
const StakingPoolEdit = () => {
    ...
    const fetchPoolData = async () => {
        ...
        if (!error && data) {
            ...
            setCurrency((formData === null || formData === void 0 ? void 0 : formData.currencies[data.type].find((cur) => cur.value === data.currency)) || null);
            setChain(((_a = formData === null || formData === void 0 ? void 0 : formData.chains[data.currency]) === null || _a === void 0 ? void 0 : _a.find((chain) => chain === data.chain))
    ...
    if (!formData)
        return null;
    return (<Default_1.default title={t("Edit Staking Pool")} color="muted">
...
exports.default = StakingPoolEdit;
