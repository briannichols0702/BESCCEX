...
const Investments = () => {
    ...
    return (<Default_1.default title={t("Investments")} color="muted">
      <datatable_1.DataTable title={t("Investments")} endpoint={api} columnConfig={columnConfig} canCreate={false} hasAnalytics/>
    </Default_1.default>);
};
