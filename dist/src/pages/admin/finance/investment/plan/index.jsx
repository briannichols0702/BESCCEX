...
const InvestmentPlans = () => {
    ...
    return (<Default_1.default title={t("Investment Plans")} color="muted">
      <datatable_1.DataTable title={t("Investment Plans")} endpoint={api} columnConfig={columnConfig}/>
    </Default_1.default>);
};
exports.default = InvestmentPlans;
exports.permission = "Access Investment Plan Management";
