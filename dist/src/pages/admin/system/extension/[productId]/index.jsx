...
const ExtensionDetails = ({ initialProductId, initialProductVersion, initialLicenseVerified, initialUpdateData, initialProductName, initialProductTitle, initialProductStatus, }) => {
    ...
    const [productName] = (0, react_1.useState)(initialProductName);
    const [productTitle] = (0, react_1.useState)(initialProductTitle);
    ...
    const [productStatus, setProductStatus] = (0, react_1.useState)(initialProductStatus);
    // Loading states
    ...
    return (<Default_1.default title={t("Extension Details")} color="muted">
      ...
      <div className="flex justify-between items-center w-full mb-8 text-muted-800 dark:text-muted-200">
        ...
        <div className="flex items-center space-x-3">
          ...
          {parseFloat(productVersion) >= 4 && (<Button_1.default color={productStatus ? "danger" : "success"} onClick={handleActivateExtension} disabled={isSubmitting} loading={isSubmitting}>
              <react_2.Icon icon={productStatus ? "carbon:close" : "carbon:checkmark"} className="mr-2 h-5 w-5"/>
              {productStatus ? t("Disable") : t("Enable")}
            </Button_1.default>)}
          <BackButton_1.BackButton href={"/admin/system/extension"}/>
        </div>
      </div>
...
async function getServerSideProps(context) {
    ...
    try {
        ...
        // Fetch product data
        const productResponse = await (0, api_1.$serverFetch)(context, {
...
exports.default = ExtensionDetails;
