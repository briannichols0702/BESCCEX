...
const Orderbook_1 = require("@/components/pages/trade/orderbook/Orderbook");
const trades_1 = require("@/components/pages/trade/trades");
const chart_1 = require("@/components/pages/trade/chart");
const markets_1 = require("@/components/pages/trade/markets");
const ticker_1 = require("@/components/pages/trade/ticker");
const order_1 = require("@/components/pages/trade/order");
const orders_1 = require("@/components/pages/trade/orders");
const market_1 = __importDefault(require("@/stores/trade/market"));
const dashboard_1 = require("@/stores/dashboard");
const router_1 = require("next/router");
const TradePage = () => {
    const { market, setWithEco } = (0, market_1.default)();
    const { hasExtension, extensions } = (0, dashboard_1.useDashboardStore)();
