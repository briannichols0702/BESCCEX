...
const SelectWalletType_1 = require("@/components/pages/user/forex/deposit/SelectWalletType");
const SelectCurrency_1 = require("@/components/pages/user/forex/deposit/SelectCurrency");
const SelectNetwork_1 = require("@/components/pages/user/forex/deposit/SelectNetwork");
const deposit_1 = require("@/stores/user/forex/deposit");
const DepositAmount_1 = require("@/components/pages/user/forex/deposit/DepositAmount");
const DepositConfirmed_1 = require("@/components/pages/user/forex/deposit/DepositConfirmed");
const next_i18next_1 = require("next-i18next");
const router_1 = require("next/router");
function AuthWizard() {
    const { t } = (0, next_i18next_1.useTranslation)();
    const { step, selectedWalletType, clearAll } = (0, deposit_1.useDepositStore)();
    ...
    return (<Minimal_1.default title={t("Wizard")} color="muted">
      <main className="relative min-h-screen">
        ...
        <form action="#" method="POST" className="relative mx-auto flex min-h-screen max-w-4xl flex-col items-stretch pt-36">
          ...
          {step === 4 && <DepositAmount_1.DepositAmount />}
