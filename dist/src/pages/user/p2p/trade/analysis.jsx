...
const P2PsAnalytics = () => {
    ...
    return (<Default_1.default color="muted" title={t("P2P Trades Analytics")}>
      <AnalyticsChart_1.AnalyticsChart model="p2pTrade" modelName={t("P2P Trades")} cardName={t("Trades")} availableFilters={availableFilters} color="primary" path={`/api/ext/p2p/trade/analysis`} pathModel={true}/>
    </Default_1.default>);
};
