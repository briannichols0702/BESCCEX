...
exports.useWithdrawStore = (0, zustand_1.create)()((0, immer_1.immer)((set, get) => ({
    ...
    handleWithdraw: async (id) => {
        const { selectedWalletType, withdrawAmount, selectedCurrency, selectedWithdrawMethod, setLoading, } = get();
        setLoading(true);
        ...
        const { data, error } = await (0, api_1.default)({
            ...
            body: {
                ...
                chain: selectedWalletType.value !== "FIAT"
                    ? selectedWithdrawMethod === null || selectedWithdrawMethod === void 0 ? void 0 : selectedWithdrawMethod.chain
                    : undefined,
