  ...
  return (
    <section className="w-full px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto dark:bg-black bg-white dark:bg-dot-white/[0.1] bg-dot-black/[0.1] relative">
      ...
      <section className="mt-12 text-center">
        ...
        <img
          src="https://dd.dexscreener.com/ds-data/tokens/solana/DDE8MnEjYsukfiG2DCu4EeJM3wU4jngLci65mQyzYs7H.png?size=lg&key=a7cf49"
          alt="$BESC Token"
        ...
        <div className="mt-6">
          <a
            href="https://raydium.io/swap/?inputMint=sol&outputMint=DDE8MnEjYsukfiG2DCu4EeJM3wU4jngLci65mQyzYs7H"
            target="_blank"
